...
class QueryRunner:
    ...
    def run_searches_with_parameters(self, base_query: SolrQuery, searches: List[str], return_field="id"):
        ...
        for search in searches:
            ...
            result = self.run_query(self.solr_client, query, return_field)
            results.append((search, result))
        return results

    def run_queries(self, queries: List[SolrQuery], return_field="id") -> List[Tuple[str, List[str]]]:
